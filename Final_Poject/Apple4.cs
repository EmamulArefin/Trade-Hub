...
{
    public partial class Apple4 : Form
    {
        public Apple4()
        {
            InitializeComponent();
        ...
        int intimgnum = 0;
        private void Apple4_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 5; // Replace this with the actual product ID you want to add to the cart
