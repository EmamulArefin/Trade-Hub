...
{
    public partial class Asus1 : Form
    {
        public Asus1()
        {
            InitializeComponent();
        ...
        private void Asus1_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 12; // Replace this with the actual product ID you want to add to the cart
