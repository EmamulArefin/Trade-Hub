...
{
    public partial class Acer1 : Form
    {
        public Acer1()
        {
            InitializeComponent();
        ...
        private void Acer1_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 21; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Acer TravelMate.pdf", FileMode.Create));
            pdoc.Open();
