...
{
    public partial class Asus2 : Form
    {
        public Asus2()
        {
            InitializeComponent();
        ...
        private void Asus2_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 13; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\VivoBook 15.pdf", FileMode.Create));
            pdoc.Open();
