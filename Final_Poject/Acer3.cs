...
{
    public partial class Acer3 : Form
    {
        public Acer3()
        {
            InitializeComponent();
        ...
        private void Acer3_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 23; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Acer TravelMate TMP.pdf", FileMode.Create));
            pdoc.Open();
