...
namespace Final_Poject
{
    public partial class Form11 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 49; // Replace this with the actual product ID you want to add to the cart
        ...
        {
            // Fetch the product details from ProductsDatabase
            int productIdToAdd = 50; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-4.pdf", FileMode.Create));
            pdoc.Open();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-5.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-6.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
