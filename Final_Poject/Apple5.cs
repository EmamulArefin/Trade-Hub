...
{
    public partial class Apple5 : Form
    {
        public Apple5()
        {
            InitializeComponent();
        ...
        private void Apple5_Load_1(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 6; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Apple MacBook Pro 14-inch M2 Pro.pdf", FileMode.Create));
            pdoc.Open();
