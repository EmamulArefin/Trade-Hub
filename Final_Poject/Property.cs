...
namespace Final_Poject
{
    public partial class Property : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 46; // Replace this with the actual product ID you want to add to the cart
        ...
        {
            // Fetch the product details from ProductsDatabase
            int productIdToAdd = 48; // Replace this with the actual product ID you want to add to the cart
        ...
        {
            // Fetch the product details from ProductsDatabase
            int productIdToAdd = 47; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-1.pdf", FileMode.Create));
            pdoc.Open();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-2.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\HOUSE-3.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
