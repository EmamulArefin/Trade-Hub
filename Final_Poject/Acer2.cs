...
namespace Final_Poject
{
    public partial class Acer2 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 22; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Acer Aspire7.pdf", FileMode.Create));
            pdoc.Open();
