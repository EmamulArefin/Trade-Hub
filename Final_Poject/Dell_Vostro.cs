...
{
    public partial class Dell_Vostro : Form
    {
        public Dell_Vostro()
        {
            InitializeComponent();
        ...
        private void Dell_Vostro_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 17; // Replace this with the actual product ID you want to add to the cart
