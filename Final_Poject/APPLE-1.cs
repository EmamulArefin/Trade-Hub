...
{
    public partial class APPLE_1 : Form
    {
        public APPLE_1()
        {
            InitializeComponent();
        ...
        private void APPLE_1_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int ProductId = 1; // Replace this with the actual product ID you want to add to the cart

            Product productToAdd = GetProductDetails(ProductId);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Apple MacBook Air 13.3-Inch.pdf", FileMode.Create));
            pdoc.Open();
