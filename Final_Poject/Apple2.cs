...
{
    public partial class Apple2 : Form
    {
        public Apple2()
        {
            InitializeComponent();
        ...
        private void Apple2_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 2; // Replace this with the actual product ID you want to add to the cart
