...
namespace Final_Poject
{
    public partial class HP4 : Form
    {
        ...
        private void HP4_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 10; // Replace this with the actual product ID you want to add to the cart
