...
namespace Final_Poject
{
    public partial class EC3 : Form
    {
        ...
        private void EC3_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 33; // Replace this with the actual product ID you want to add to the cart
        ...
        {
            // Fetch the product details from ProductsDatabase
            int productIdToAdd = 34; // Replace this with the actual product ID you want to add to the cart
        ...
        {
            // Fetch the product details from ProductsDatabase
            int productIdToAdd = 35; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Wni-5f3-GDEL-XX 5631.pdf", FileMode.Create));
            pdoc.Open();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\ECO+ 566 liter black glass.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Haier HRF-578TBG 522Ltr.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
        ...
        {
            Document pdoc = new Document(PageSize.NOTE);
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Haier HRF-330WDBG 319.pdf", FileMode.Create));
            pdoc.Open();
            Paragraph p1 = new Paragraph("Name : ZELANI JIDAN \nMobail:01601288732 \nGmail : akzelani2001@gmail.com \nLocation :Boshundhara,Dhaka,Bangladesh   ");
            pdoc.Add(p1);
            pdoc.Close();
