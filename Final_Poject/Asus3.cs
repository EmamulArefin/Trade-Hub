...
{
    public partial class Asus3 : Form
    {
        public Asus3()
        {
            InitializeComponent();
        ...
        private void Asus3_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 14; // Replace this with the actual product ID you want to add to the cart
