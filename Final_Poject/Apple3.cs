...
{
    public partial class Apple3 : Form
    {
        public Apple3()
        {
            InitializeComponent();
        ...
        private void Apple3_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            int productIdToAdd = 4; // Replace this with the actual product ID you want to add to the cart
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter p = PdfWriter.GetInstance(pdoc, new FileStream("D:\\Apple MacBook Air 13.3-Inch 2022.pdf", FileMode.Create));
            pdoc.Open();
